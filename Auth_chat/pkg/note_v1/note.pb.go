...
var file_note_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xa4, 0x01, 0x0a, 0x11, 0x43, 0x72,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x89, 0x01, 0x0a, 0x11,
	...
	0x0a, 0x05, 0x41, 0x44, 0x4d, 0x49, 0x4e, 0x10, 0x01, 0x32, 0xf4, 0x01, 0x0a, 0x0b, 0x55, 0x73,
...
var file_note_proto_depIdxs = []int32{
	...
	0,  // 3: auth.CreateUserRequest.role:type_name -> auth.Role
	1,  // 4: auth.GetUserResponse.user:type_name -> auth.User
	9,  // 5: auth.UpdateUserRequest.name:type_name -> google.protobuf.StringValue
	9,  // 6: auth.UpdateUserRequest.email:type_name -> google.protobuf.StringValue
	2,  // 7: auth.UserService.Create:input_type -> auth.CreateUserRequest
	4,  // 8: auth.UserService.Get:input_type -> auth.GetUserRequest
	6,  // 9: auth.UserService.Update:input_type -> auth.UpdateUserRequest
	7,  // 10: auth.UserService.Delete:input_type -> auth.DeleteUserRequest
	3,  // 11: auth.UserService.Create:output_type -> auth.CreateUserResponse
	5,  // 12: auth.UserService.Get:output_type -> auth.GetUserResponse
	10, // 13: auth.UserService.Update:output_type -> google.protobuf.Empty
	10, // 14: auth.UserService.Delete:output_type -> google.protobuf.Empty
