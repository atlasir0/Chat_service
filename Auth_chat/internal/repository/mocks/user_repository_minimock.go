...
//go:generate minimock -i github.com/atlasir0/Chat_service/Auth_chat/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, req *model.User) (i1 int64, err error)
	...
	funcUpdate          func(ctx context.Context, req *model.User) (ep1 *emptypb.Empty, err error)
...
func (mmCreate *mUserRepositoryMockCreate) ExpectReqParam2(req *model.User) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, req *model.User) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, req *model.User) (i1 int64, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter req, want: %#v, got: %#v%s\n", *mm_want_ptrs.req, mm_got.req, minimock.Diff(*mm_want_ptrs.req, mm_got.req))
			}
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectReqParam2(req *model.User) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, req *model.User) (ep1 *emptypb.Empty, err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, req *model.User) (ep1 *emptypb.Empty, err error) {
