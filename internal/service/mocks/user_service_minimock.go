...
//go:generate minimock -i github.com/atlasir0/Chat_service/Auth_chat/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcUpdate          func(ctx context.Context, info *model.User, req *model.User) (ep1 *emptypb.Empty, err error)
	inspectFuncUpdate   func(ctx context.Context, info *model.User, req *model.User)
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, info *model.User, req *model.User) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, info, req}
...
// ExpectInfoParam2 sets up expected param info for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectInfoParam2(info *model.User) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) ExpectReqParam3(req *model.User) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, info *model.User, req *model.User)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, info *model.User, req *model.User) (ep1 *emptypb.Empty, err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, info *model.User, req *model.User) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, info, req},
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, info *model.User, req *model.User) (ep1 *emptypb.Empty, err error) {
	mm_atomic.AddUint64(&mmUpdate.beforeUpdateCounter, 1)
	defer mm_atomic.AddUint64(&mmUpdate.afterUpdateCounter, 1)

	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, info, req)
	}

	mm_params := UserServiceMockUpdateParams{ctx, info, req}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, info, req}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, info, req)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v %v", ctx, info, req)
	return
}
